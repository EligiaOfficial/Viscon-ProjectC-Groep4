                        ...
                        <section className="p-2">
                            <div className="ml-20">
                                <div className="w-100 bg-gray-150 mt-20">
                                    <div className="mt-50 w-100 flex flex-col my-auto items-center">
                                        <h1 className={"mb-5 text-3xl font-bold text-center text-blue-900"}>Add User</h1>
                                        <form className="flex justify-center" onSubmit={handleSubmit}>
                                            <div className={"mr-0 md:mr-20"}>
                                                <div className={"mt-1"}>
                                                    <label htmlFor="email" className="block text-xs font-medium leading-2 text-gray-500">First & Last Names</label>
                                                    <div className="mt-1 flex">
                                                        <input
                                                            ...
                                                            required
                                                            className="pl-2 block w-full rounded-md border-0 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 sm:text-sm sm:leading-6" />
                                                ...
                                                <div>
                                                    <label htmlFor="email" className="block text-xs font-medium leading-2 text-gray-500">Email address</label>
                                                    <div className="mt-1">
                                                        <input
                                                            id="email"
                                                            value={email}
