    ...
    return (
        <div className="h-[50px] p-1 shadow-md shadow-stone-200 flex flex-row justify-between">
            ...
            <div className="flex items-center justify-between gap-16 pr-10">
                ...
                <div onClick={() => languageToggled(true)} className="z-10 relative select-none relative group flex flex-row items-center gap-2 cursor-pointer">
                    ...
                    <svg className="z-10 transition ease-in-out duration-300 delay-100 object-contain max-h-[20px] max-w-[20px] fill-black group-hover:fill-[#07ab9a]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                ...
                <div onMouseLeave={() => languageToggled(false)} className={`${changeLanguage ? "grid-rows-[1fr] border-gray-200" : ""} select-none w-[140px] border border-transparent absolute right-0 top-0 translate-y-[40px] translate-x-[-10px] grid grid-rows-[0fr] bg-white rounded-sm shadow-md transition-[grid] duration-300 ease-in-out`}>
